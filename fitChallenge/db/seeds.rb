...
challenge1 = Challenge.create! title: "Gym", description: "Go to the gym", points: 100 , start_date: Date.today , end_date: Date.today + 7 , creator_id: user1.id  
challenge2 = Challenge.create! title: "Diet", description: "300 cal deficit", points: 50 , start_date: Date.today , end_date: Date.today + 7 , creator_id: user1.id
